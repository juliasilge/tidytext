...
If we want to analyze this with tidy tools, we'd have to turn it into a one-term-per-document-per-row data frame first. The `tidy` function does this:
...
This allows early reading, filtering and processing to be done using dplyr and other tidy tools, then converted into a document-term matrix for machine learning applications.

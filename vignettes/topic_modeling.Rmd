...
Topic modeling is a way of discovering what a document is about based on which words appear more and less frequently compared to other documents. We can use tidy data principles, as described in [the main vignette](tidytext.html), to approach topic modeling, using consistent, effective tools.

...
Some of these topics are pretty clearly associated with one book! There's no question that the topic of "nemo", "sea", and "nautilus" belongs to *Twenty Thousand Leagues Under the Sea*, and that "jane", "darcy", and "elizabeth" belongs to Pride and Prejudice. On the other hand, we can spot at least one mistake: that "wemmick" (meaning John Wemmick, a character from *Great Expectations*) was associated with "martians" (from *The War of the Worlds*).

#### Per-document classification

Each "chapter" was a document in this analysis. Thus, we may want to know which topics describe each document.
...
We see that one chapter from Great Expectations was misclassified as *War of the Worlds*. Still, not bad for unsupervised clustering!
...
This doesn't mean those words necessarily appeared in *War of the Worlds*! Indeed, we can confirm they appear only in *Great Expectations*:
...
However, the algorithm is stochastic and iterative, and it can accidentally land on a topic that spans multiple books.
